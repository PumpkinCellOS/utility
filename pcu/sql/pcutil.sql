...
CREATE TABLE `modules` (
  ...
  `commandURL` varchar(2048) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'http://pumpkincell.net/api/module/invalid.php' COMMENT 'URL with command API.',
...
CREATE TABLE `users` (
  ...
  `role` enum('member','owner','admin','default','trusted','moderator') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'default',
...
--
ALTER TABLE `modules`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT 'Module ID', AUTO_INCREMENT=4;
